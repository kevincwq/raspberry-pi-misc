...
internal static class Font8x8
{
    private static readonly IReadOnlyDictionary<char, byte[]> FONTDICT = new Dictionary<char, byte[]> {
            ...
            {'\u2547', new byte[]{ 0x08, 0x08, 0x08, 0xff, 0xff, 0x18, 0x18, 0x18}},   // U+2547 (up L, right H, left H, down H)
            {'\u254B', new byte[]{ 0x18, 0x18, 0x18, 0xff, 0xff, 0x08, 0x08, 0x08}},   // U+254B (up H, right H, left H, down L)
            ...
            {'\u00B2', new byte[]{ 0x1C, 0x30, 0x18, 0x30, 0x1C, 0x00, 0x00, 0x00}},   // U+00B2 (superscript 3)
            {'\u00B2', new byte[]{ 0x18, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},   // U+00B2 (aigu)
            ...
            {'\u0399', new byte[]{ 0x33, 0x00, 0x1E, 0x0C, 0x0C, 0x0C, 0x1E, 0x00}},   // U+0399 (Iota with diaeresis)
            {'\u03A5', new byte[]{ 0x33, 0x00, 0x33, 0x33, 0x1E, 0x0C, 0x1E, 0x00}},   // U+03A5 (Upsilon with diaeresis)
            ...
            {'\u0060', new byte[]{ 0x0C, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},   // U+0060 (grave)
